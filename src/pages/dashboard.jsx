                ...
                <div className=" flex-1 min-h-0 flex     text-white">
                    ...
                    <div className="flex-none  w-20 flex flex-col  items-center  ">
                        ...
                        <div className=" relative  mb-2 pb-3  w-20 flex items-center justify-center ">
                            <span class="peer flex h-12 w-12 cursor-pointer mt-1 ml-1 items-center justify-center bg-zinc-800  text-white transition-all duration-200 ease-in-out rounded-2xl hover:bg-[#5865f2] ">
                        ...
                        <div className=" flex justify-center items-center  w-20">
                            <span class="  flex h-12 w-12 cursor-pointer mt-2 ml-1 items-center justify-center bg-zinc-800  text-white transition-all duration-200 ease-in-out rounded-2xl hover:bg-[#5865f2] ">
                                <svg xmlns="http://w3.org" viewBox="0 0 24 24" class="w-6 h-6 cursor-pointer text-zinc-700 hover:text-zinc-900 transition-colors">
                        ...
                        <div className=" relative flex justify-center items-center  w-20">
                            <span class=" peer flex h-12 w-12 cursor-pointer mt-2 ml-1 items-center justify-center bg-zinc-800  text-white transition-all duration-200 ease-in-out rounded-2xl hover:bg-[#5865f2] ">
                                <svg xmlns="www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                            ...
                            <div className="absolute left-0 w-1 bg-white h-0 rounded-r-full transition-all duration-300 peer-hover:h-7" />
                            <div className="absolute -right-21 top-3 py-5 px-2 h-8 bg-zinc-600 rounded-xl flex items-center justify-center opacity-0 font-black text-base peer-hover:opacity-100 " >Discover
                                <div class="absolute -left-2 h-0 w-0 border-y-[8px] rounded-sm  border-y-transparent border-r-[13px] border-r-zinc-600" />
