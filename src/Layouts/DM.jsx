        ...
        <>
            ...
            <div className="flex-none  w-80 h-full flex flex-col  rounded-l-xl border-t border-l border-zinc-800 ">
                ...
                <div className="h-17 flex items-center justify-center border-b border-b-neutral-800 mt-1  ">
                    ...
                    <span className=" flex  gap-x-3 pl-1 p-2 w-72 h-10 text-zinc-200 font-semibold  bg-neutral-800 rounded-xl   transition-colors hover:bg-zinc-100/10">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            fill="CurrentColor"
                        ...
                        <div className="absolute right-0 -top-26 max-w-[110px] ">
                            <svg xmlns="http://w3.org" viewBox="0 0 240 240" width="100%" height="100%">
                                <g id="wumpus-mascot" transform="translate(10, 35)">
                                    ...
                                    <path d="M 46 122 Q 54 136, 46 158" stroke="#D5D8DC" stroke-width="1.5" fill="none" />
                                    ...
                                    <path d="M 116 130 Q 124 133, 129 125" stroke="#111214" stroke-width="4.5" fill="none" stroke-linecap="round" />
                                    ...
                                    <g transform="translate(102, 42) rotate(12) translate(-102, -42)">
                                        ...
                                        <path d="M 104 40 Q 106 48, 112 52" stroke="#2E8B4C" stroke-width="3.5" fill="none" stroke-linecap="round" />
                                    </g>

                                    <path d="M 52 144 C 58 141, 68 140, 76 140 L 136 140 C 144 140, 154 141, 160 144 L 168 190 L 44 190 Z" fill="#FFFFFF" />

                                    <line x1="104" y1="140" x2="104" y2="190" stroke="#232428" stroke-width="5" />
                                    <path d="M 96 146 L 112 146 L 108 162 L 100 162 Z" fill="#232428" />
                                    <circle cx="104" cy="156" r="2" fill="#FFFFFF" />

                                    <path d="M 132 190 C 132 178, 140 172, 154 176" stroke="#D5D8DC" stroke-width="2" fill="none" />
